export function AudioInput() {
  return (
    <div className="w-full flex flex-col justify-center items-center gap-1 py-16 border-dashed border-primary-dark border-2	rounded-lg">
      <input type="file" id="audio-input" className="hidden" />
