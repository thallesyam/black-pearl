type IAddButton = React.DetailedHTMLProps<React.ButtonHTMLAttributes<HTMLButtonElement>, HTMLButtonElement>

export function AddButton(props: IAddButton) {
  return (
    <div className="w-full bg-white-dark absolute left-0 -bottom-4 py-2 rounded-b-lg flex justify-center">
      <button className="w-12 h-12 rounded-lg bg-white border-dashed border-primary-dark border-2" {...props}>
